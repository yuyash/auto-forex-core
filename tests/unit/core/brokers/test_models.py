...
def test_order_id_is_uuidv7_value_object() -> None:
...
def test_broker_ids_order_reason_and_transaction_are_value_objects() -> None:
...
def test_order_normalizes_price_currency() -> None:
    order = Order(
        instrument=USD_JPY,
        side=OrderSide.BUY,
        units=Decimal("1000"),
