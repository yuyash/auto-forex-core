...
def test_ticks_default_granularity_yields_every_tick() -> None:
...
def test_ticks_downsamples_to_one_per_interval_bucket() -> None:
    ...
    assert [tick.bid for tick in result] == [Money.of("150.00", "JPY"), Money.of("150.03", "JPY")]


def test_ticks_explicit_tick_granularity_is_passthrough() -> None:
