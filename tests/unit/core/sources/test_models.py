...
class TestModels:
    def test_tick_calculates_mid_and_spread(self) -> None:
        tick = Tick(
            instrument=USD_JPY,
    ...
    def test_tick_rejects_naive_datetime_and_invalid_prices(self) -> None:
    ...
    def test_candle_validates_ohlc_range_and_metadata(self) -> None:
